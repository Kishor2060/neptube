        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {plans?.map((plan) => {
            ...
            return (
              <Card
                key={plan.tier}
                className={`bg-card border-2 ${TIER_COLORS[plan.tier]} ${
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="py-4">
            <RadioGroup
              ...
              className="space-y-3"
            >
              <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:border-green-500 transition-colors cursor-pointer">
                <RadioGroupItem value="esewa" id="esewa" />
                <Label htmlFor="esewa" className="flex-1 cursor-pointer">
                  <div className="font-medium text-foreground">eSewa</div>
                  <div className="text-xs text-muted-foreground">Nepal&apos;s digital wallet</div>
                </Label>
                <span className="text-green-500 font-bold text-sm">eSewa</span>
              </div>

              <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:border-purple-500 transition-colors cursor-pointer">
                <RadioGroupItem value="khalti" id="khalti" />
                <Label htmlFor="khalti" className="flex-1 cursor-pointer">
                  <div className="font-medium text-foreground">Khalti</div>
                  <div className="text-xs text-muted-foreground">Digital wallet & payment</div>
                </Label>
                <span className="text-purple-500 font-bold text-sm">Khalti</span>
              </div>

              <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:border-blue-500 transition-colors cursor-pointer">
              ...
              <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:border-sky-500 transition-colors cursor-pointer">
